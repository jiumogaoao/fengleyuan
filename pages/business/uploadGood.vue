	...
	<view class="content">
		<view class="list">
			<view class="row b-b">
				...
				<input class="input" type="text" placeholder="请输入商品名称" placeholder-class="placeholder" />
			</view>
			<view class="row b-b">
				<text class="tit">快递费用<text class="must">*</text></text>
				<input class="input" type="text" placeholder="请输入快递费用" placeholder-class="placeholder" />
			</view>
			...
			<view class="row b-b">
				...
				<view class="input">点击选择商品保障</view>
			</view>
			<view class="picRow">
				...
				<view class="picList">
					<view class="newPicFrame">
						<image src="/static/found0.png" class="newPic"></image>
						<image class="removePic" src="/static/removePic.png"></image>
					</view>
					<image class="pic" src="/static/uploadGoodPic.png"></image>
				</view>
			</view>
			<view class="picRow">
				...
				<view class="picList">
					...
					<image class="pic" src="/static/uploadDetailPic.png"></image>
				</view>
			</view>
		</view>
